...
function addRow() {
    ...
    var addRown= document.getElementById('tfaculty');
    var NewRow= addRown.inserRow(n)

    list1 [x] = document.getElementById('third','first', 'second');
    list2 [x] = document.getElementById('department');
    list3 [x] = document.getElementById('designation');
    list2 [x] = document.getElementById('department');
}